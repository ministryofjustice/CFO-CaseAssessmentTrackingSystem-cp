...
public static class MassTransitExtensions
{
    ...
    public static void ConfigureAmazonSqs(this IAmazonSqsBusFactoryConfigurator cfg, IBusRegistrationContext context, string host)
    {
        ...
        cfg.Publish<ActivityApprovedIntegrationEvent>(cfg => cfg.TopicAttributes["FifoTopic"] = true);
        ...
        cfg.Publish<HubInductionCreatedIntegrationEvent>(cfg => cfg.TopicAttributes["FifoTopic"] = true);
        ...
        cfg.Publish<ObjectiveTaskCompletedIntegrationEvent>(cfg => cfg.TopicAttributes["FifoTopic"] = true);
        ...
        cfg.Publish<ParticipantTransitionedIntegrationEvent>(cfg => cfg.TopicAttributes["FifoTopic"] = true);
        ...
        cfg.Publish<PRIAssignedIntegrationEvent>(cfg => cfg.TopicAttributes["FifoTopic"] = true);
        ...
        cfg.Publish<PRIThroughTheGateCompletedIntegrationEvent>(cfg => cfg.TopicAttributes["FifoTopic"] = true);
        ...
        cfg.Publish<SyncParticipantCommand>(cfg => cfg.TopicAttributes["FifoTopic"] = true);
        ...
        cfg.Publish<WingInductionCreatedIntegrationEvent>(cfg => cfg.TopicAttributes["FifoTopic"] = true);
